import { faMap, faNewspaper, faPencilAlt, faWindowClose } from '@fortawesome/free-solid-svg-icons';
...
function EditSites({ fetch, site }) {
    ...
    useEffect(() => {
        setState(s => ({
            ...removeItem(Disperse(site), '_id'), //disperse the site data into {value:'',site:''}
    ...
    const handleSubmit = async e => {
        ...
        try {
            if (state.images.length !== 0) {
                ...
                state.images.forEach(i => data.append('images', i.image, i.name))

                setSave(s => ({ ...s, process: 'saving...', error: '', success: '' }))
                const save = await axios.put(host + 'site/' + site._id, data, {
                    ...getHeaders(),
                            ...
                            <div className="row">
                                <div className="col-lg-6 text-dark">
                                    ...
                                    <div className="my-3">
                                        ...
                                        <div id="float">
                                            <select id="region" required='true' value={state.region.value} className='form-control' onChange={handleChange}>
                                                <option value=""></option>
                                    ...
                                    <div className="my-3">
                                        <div id="float-label">
                                            ...
                                            <input type="text" className='form-control' id='lat'
                                                onChange={handleChange} value={state.lat.value}
                                            />
                                        </div>
                                    </div>
                                    <div className="my-3">
                                        <div id="float-label">
                                            ...
                                            <input type="text" className='form-control' id='lng'
                                                onChange={handleChange} value={state.lng.value}
                                            />
                                        </div>
                                    </div>
                                    <div className="my-3">

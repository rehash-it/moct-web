...
function DeleteForum({ forum, fetch }) {
    ...
    const deleteForum = async () => {
        try {
            ...
            const del = await axios.delete(host + 'forum/' + forum._id, getHeaders())
            if (del.status === 200) {
            ...
            <Modal isOpen={modal} toggle={toggle} size='md' style={{ paddingTop: 200 }}>
                ...
                <ModalBody>
                    <p className="text-dark">
                        ...
                        Are you sure to delete this Forum
                    </p>
                    {save.process ?
                ...
                <ModalFooter>
                    <Button color="primary" onClick={deleteForum}>
                        Delete Forum
                    </Button>{' '}
                </ModalFooter>
            </Modal>
